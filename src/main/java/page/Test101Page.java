...
public class Test101Page {
	...
	String categoryType = "Tarini" + new Random().nextInt(999);
	String duplicateType = "Tarini";
...
@Test
	...
	public boolean insertduplicateCategory() {
	...
	public void addDuplicate() {
		...
		boolean actual = insertduplicateCategory();
